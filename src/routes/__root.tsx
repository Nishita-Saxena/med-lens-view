  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Something went wrong. Try again or return to the MedLens dashboard.</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Organize, review, and understand medical records with traceable source information and human verification." },
      { name: "author", content: "MedLens" },
      { property: "og:title", content: "MedLens — Clinical Information Intelligence" },
      { property: "og:description", content: "A source-aware medical information workspace for review, organization, and patient-friendly summaries." },
